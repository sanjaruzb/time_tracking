            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Создать новую oтдел</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <label for="code"><strong>Код:</strong></label>{!! Form::label('code',"*",['style'=>"color:red"]) !!}
                                    {!! Form::text('code', null, ['autocomplete'=>'OFF','id'=>'code','placeholder' => 'Код','required'=>true,'class' => "form-control ".($errors->has('code') ? 'is-invalid' : '')]) !!}
                                    @if($errors->has('code'))
