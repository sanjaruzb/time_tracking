            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Управление информация</h3>

                        @can('holiday-create')
                            <a href="{{ route('holiday.create') }}" class="btn btn-success btn-sm float-right">
                        ...
                        @can('holiday-filter')
                            <button type="button" class="btn btn-primary btn-sm float-right" data-toggle="modal" data-target="#holiday_filter" style="margin-right: 5px">
                    ...
                    <div class="card-body">
                            ...
                            @foreach($holidays as $holiday)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            @can('holiday-show')
                                                <a class="" href="{{ route('holiday.show',$holiday->id) }}"
                                            ...
                                            @can('holiday-edit')
                                                <a class="" href="{{ route('holiday.edit',$holiday->id) }}"
                        ...
                        <div class="modal fade" id="holiday_filter">
