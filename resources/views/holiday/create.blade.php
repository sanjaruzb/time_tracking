            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Создать новую информация</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('type', \App\Helpers\HolidayHelper::$holidays,null, ['autocomplete'=>'OFF','id'=>'type','required'=>true,'class' => "form-control ".($errors->has('type') ? 'is-invalid' : '')]) !!}
                                    @if($errors->has('type'))
