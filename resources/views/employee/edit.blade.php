            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Изменить сотрудник</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('position_id',$positions, $employee->position_id, ['autocomplete'=>'OFF','id'=>'position_id','placeholder' => '','required'=>true,'class' => "form-control ".($errors->has('position_id') ? 'is-invalid' : '')]) !!}
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('department_id',$departments, $employee->department_id, ['autocomplete'=>'OFF','id'=>'department_id','placeholder' => '','required'=>true,'class' => "form-control ".($errors->has('department_id') ? 'is-invalid' : '')]) !!}
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('gender', \App\Models\User::$genders, $employee->gender, ['autocomplete'=>'OFF','id'=>'gender','required'=>true,'class' => "form-control ".($errors->has('gender') ? 'is-invalid' : '')]) !!}
