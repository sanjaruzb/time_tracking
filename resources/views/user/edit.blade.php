                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::password('password', ['autocomplete'=>'OFF','id'=>'password','placeholder' => 'Пароль','class' => 'form-control '.($errors->has('password') ? 'is-invalid' : '')]) !!}
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::password('password_confirmation', ['autocomplete'=>'OFF','id'=>'password_confirmation','placeholder' => 'Подтвердите пароль','class' => 'form-control '.($errors->has('confirm-password') ? 'is-invalid' : '')]) !!}
                            ...
                            <div class="col-xs-4 col-sm-4 col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('roles[]', $roles,$user->roles->pluck('name')->toArray(), ['id'=>'role', 'multiple','required'=>true, 'class' => 'form-control '.($errors->has('roles') ? 'is-invalid' : '')]) !!}
                                    @if($errors->has('roles'))
